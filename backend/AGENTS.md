...
## Project Overview
This is only applicable to the backend part of the project. This is a universal Express API that serves both a Next.js web application and a Flutter mobile application. It acts purely as a stateless data machine.
...
By placing this file in your root directory, any time you ask an agent to "create the login route" or "build the products endpoint," it will automatically format the response envelope, implement JWT authentication, and skip HTML templating without you needing to repeat yourself. 
